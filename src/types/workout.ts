...
export const DAILY_ROUTINES = {
    Monday: [
        ...
        { name: 'Bodyweight Standing Calf Raise', type: 'reps', targetReps: 50, gif: 'https://fitnessprogramer.com/wp-content/uploads/2021/06/Standing-Calf-Raise.gif' },
    ...
    Thursday: [
        ...
        { name: 'Captains Chair Leg Raise', type: 'reps', targetReps: 30, gif: 'https://fitnessprogramer.com/wp-content/uploads/2021/05/Captains-Chair-Leg-Raise.gif' },
        { name: 'Bench Side Bend', type: 'reps', targetReps: 40, gif: 'https://fitnessprogramer.com/wp-content/uploads/2021/05/Bench-Side-Bend.gif' },
        { name: 'Weighted Back Extension', type: 'reps', targetReps: 25, gif: 'https://fitnessprogramer.com/wp-content/uploads/2021/06/Weighted-Back-Extension.gif' }
    ],
    Friday: [
